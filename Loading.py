...
class Loading:
    def __init__(self, job, plotter, dt=-0.03, side=.3, r=1, ncubes=12, color='teal'):
    ...
    def initialize(self):
        ...
        for n, cube in enumerate(self.cubes):
            ...
            cube.x(x).y(y)
        show(*self.cubes, interactive=False, resetcam=True, zoom=1/3, at=0)
    ...
    def animate(self):
        ...
        show(*self.cubes, interactive=False, resetcam=False, at=0)
